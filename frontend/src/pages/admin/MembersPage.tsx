          ...
          <Table sx={{ minWidth: 840 }}>
            <TableHead>
              <TableRow sx={{ bgcolor: "#FF9900" }}>
                <TableCell sx={{ fontWeight: 950, color: "#fff" }}>Member</TableCell>
      ...
      <Stack spacing={1.2} sx={{ display: { xs: "flex", md: "none" } }}>
        ...
        {rows.length === 0 && (
          <Paper elevation={0} sx={{ ...cardSx, p: 2, textAlign: "center" }}>
            <Typography sx={{ color: "#64748B", fontWeight: 800 }}>No members</Typography>
          </Paper>
        )}
      </Stack>
    </Box>
